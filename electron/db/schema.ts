...
export const doctors = sqliteTable('Doctor', {
  ...
  spouseBirthDate:text('spouseBirthDate'),
  anniversary:    text('anniversary'),
  childrenCount:  integer('childrenCount').notNull().default(0),
  childrenNames:  text('childrenNames'),
  childrenBirthDates: text('childrenBirthDates'),
  qualification:  text('qualification').notNull(),
  specialization: text('specialization').notNull(),
  hospitalName:   text('hospitalName'),
  hospitalOpeningDate: text('hospitalOpeningDate'),
  hospitalsCount: integer('hospitalsCount').notNull().default(0),
  hospitalNames:  text('hospitalNames'),
  hospitalOpeningDates: text('hospitalOpeningDates'),
  email:          text('email'),
...
export const notifications = sqliteTable('Notification', {
  ...
  isCleared:  integer('isCleared', { mode: 'boolean' }).notNull().default(false),
  createdAt:  text('createdAt').notNull().default(sql`(datetime('now'))`),
});
